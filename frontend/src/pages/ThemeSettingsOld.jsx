...
export default function ThemeSettingsOld() {
    ...
    const handleSave = async () => {
        try {
            ...
            languages.forEach(lang => {
                if (lang.code) {
                    languagesObject[lang.code] = lang;
                }
            });

            // تبدیل اطلاعات سایت و شرکت
            const siteData = {};
            const companyData = {};
    ...
    return (
        <Box sx={{ p: 0, m: 0, width: '100%', maxWidth: '100vw'}}>
            <Box sx={{
                ...
                {/* بخش 3: شبکه‌های اجتماعی و مجوزها */}
                <Card sx={{ mb: 3 }}>
                    <CardContent>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 3 }}>
                ...
                {/* بخش 6: قالب‌های آماده */}
                <Card sx={{ mb: 3 }}>
                    <CardContent>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 3 }}>
                            <StyleIcon color="primary" />
                            <Typography variant="h6" color="primary">قالب‌های آماده</Typography>
                        </Box>
